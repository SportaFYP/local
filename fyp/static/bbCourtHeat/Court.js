...
function draw_court(){
    ...
    Basket1.attr('cx', court_xScale(0))
           .attr('cy', court_yScale(86.75))
           .attr('r', court_yScale(0.75)-court_yScale(0))
           .style('fill', 'None')
           .style('stroke', 'black');
    ...
    Backboard1.attr('x', court_xScale(-3))
           .attr('y', court_yScale(87.4))
           .attr('width', court_xScale(3)-court_xScale(-3))
           .attr('height', 1)
           .style('fill', 'none')
           .style('stroke', 'black');
    ...
    appendArcPath(RestrictedArea1, court_xScale(3)-court_xScale(0), (-90)*(Math.PI/180), (90)*(Math.PI/180))
        .attr('fill', 'none')
        .attr("stroke", "black")
        .attr("transform", "translate(" + court_xScale(0) + ", " +court_yScale(86.85) +")");
    ...
    appendArcPath(TopFreeThrow1, court_xScale(6)-court_xScale(0), (-90)*(Math.PI/180), (90)*(Math.PI/180))
        .attr('fill', 'none')
        .attr("stroke", "black")
        .attr("transform", "translate(" + court_xScale(0) + ", " +court_yScale(71) +")");
    ...
    appendArcPath(BottomFreeThrow1, court_xScale(6)-court_xScale(0), (90)*(Math.PI/180), (270)*(Math.PI/180))
        .attr('fill', 'none')
        .attr("stroke", "black")
        .style("stroke-dasharray", ("3, 3"))
        .attr("transform", "translate(" + court_xScale(0) + ", " +court_yScale(71) +")");
    ...
    appendArcPath(ThreeLine1, dis, (angle-90)*(Math.PI/180), (90-angle)*(Math.PI/180))
        .attr('fill', 'none')
        .attr("stroke", "black")
        .attr('class', 'shot-chart-court-3pt-line')
        .attr("transform", "translate(" + court_xScale(0) + ", " +court_yScale(86) +")");
    ...
    appendArcPath(CenterOuter1, court_xScale(6)-court_xScale(0), (90)*(Math.PI/180), (270)*(Math.PI/180))
        .attr('fill', 'none')
        .attr("stroke", "black")
        .attr("transform", "translate(" + court_xScale(0) + ", " +court_yScale(43) +")");
    ...
    appendArcPath(CenterInner1, court_xScale(2)-court_xScale(0), (90)*(Math.PI/180), (270)*(Math.PI/180))
        .attr('fill', 'none')
        .attr("stroke", "black")
        .attr("transform", "translate(" + court_xScale(0) + ", " +court_yScale(43) +")");
}
